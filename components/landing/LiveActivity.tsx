...
const activities = [
  ...
  { name: 'Jennifer L.', city: 'Los Angeles, CA', action: 'just joined Reeltors.ai', time: '8 min ago' },
  ...
  { name: 'David H.', city: 'Chicago, IL',      action: 'just joined Reeltors.ai',  time: '24 min ago' },
];
