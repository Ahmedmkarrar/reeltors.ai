      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-[#FAFAF8]">
        <div className="w-full max-w-[380px]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-[#E2DED6] rounded-[8px] text-sm font-medium text-[#1A1714] hover:bg-[#F5F3EF] transition-colors disabled:opacity-60 mb-6"
          >
