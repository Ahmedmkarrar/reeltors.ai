      ...
      <div className="relative z-10 max-w-2xl mx-auto p-6 md:p-8 space-y-6">
        ...
        <section className="rounded-xl border border-[#C9A84C]/25 bg-white/80 overflow-hidden backdrop-blur-sm shadow-[0_2px_12px_rgba(201,168,76,0.08)]">
          ...
          <div className="px-6 py-4 border-b border-[#F0EDE6] flex items-center justify-between">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[11px] text-[#8A8682] hover:text-[#C9930A] transition-colors duration-150"
            >
                ...
                <div className="flex flex-wrap gap-2">
                  {CATEGORIES.map((cat) => (
                    <button
                      ...
                      className={[
                        'h-7 px-3 rounded-full text-[11px] font-semibold transition-all duration-150',
                        category === cat ? 'btn-gold' : 'bg-transparent text-[#8A8682] border border-[#C9A84C]/25 hover:border-[#C9A84C]/50 hover:text-[#1A1714]',
                      ].join(' ')}
                    >
                      {cat}
                    </button>
        ...
        <section className="rounded-xl border border-[#C9A84C]/25 bg-white/80 overflow-hidden backdrop-blur-sm shadow-[0_2px_12px_rgba(201,168,76,0.08)]">
          ...
          <div className="divide-y divide-[#F0EDE6]">
            <a
              href="mailto:support@reeltors.ai"
              className="flex items-center justify-between px-6 py-4 hover:bg-[#F5F2EC]/50 transition-colors duration-150 group"
            >
              ...
              <svg className="w-4 h-4 text-[#C8C4BC] group-hover:text-[#C9930A] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
