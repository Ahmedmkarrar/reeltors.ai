    ...
    <div className="max-w-2xl mx-auto p-6 md:p-8 space-y-6">
      ...
      {isPaid && <section className="rounded-xl border border-[#E2DED6] bg-white overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
        ...
        <div className="px-6 pt-6 pb-5">
          ...
          <div className="mt-5">
            ...
            <div className="h-2 bg-[#F0EDE6] rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${usedPct}%`,
                  background: usedPct >= 90 ? '#FF5500' : usedPct >= 70 ? '#f59e0b' : meta.ring,
                }}
              />
            </div>
          ...
          {/* current plan perks — only for paid */}
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                {perks.map((perk) => (
                  <div key={perk} className="flex items-center gap-2">
                    <svg className="w-3 h-3 shrink-0" style={{ color: meta.ring }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5}>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background:  isPopular ? 'rgba(240,180,41,0.025)' : '#FAFAF8',
                    }}
                  >
                    {isPopular && (
                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#F0B429] text-[#1A1714] text-[9px] font-bold px-3 py-0.5 rounded-full whitespace-nowrap tracking-wide shadow-[0_2px_8px_rgba(240,180,41,0.35)]">
                        MOST POPULAR
                      </div>
                    )}
                    ...
                    <div className="px-5 pb-5">
                      <button
                        ...
                        className={[
                          ...
                          isPopular
                            ? 'bg-[#F0B429] text-[#1A1714] hover:bg-[#E8AC22] active:bg-[#D9A01E] shadow-[0_2px_12px_rgba(240,180,41,0.3)]'
        ...
        <section className="rounded-xl border border-[#E2DED6] bg-white overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
          <div className="px-6 py-5 flex items-center gap-4">
            ...
            <a
              ...
              className="shrink-0 inline-flex items-center gap-1.5 h-9 px-4 rounded-lg text-[12px] font-semibold border border-[#E2DED6] text-[#6B6760] bg-white hover:bg-[#F7F5F0] hover:border-[#C8C4BC] transition-all duration-150"
            >
              Contact Us →
            </a>
          </div>
        ...
        <section className="rounded-xl border border-[#E2DED6] bg-white overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
          ...
          <div className="divide-y divide-[#F0EDE6]">
            <button
              onClick={handlePortal}
              disabled={portalLoading}
              className="w-full flex items-center justify-between px-6 py-4 hover:bg-[#FAFAF8] transition-colors duration-150 group text-left disabled:opacity-50"
            >
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#F7F5F0] flex items-center justify-center shrink-0">
                  <svg className="w-4 h-4 text-[#8A8682]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
                  </svg>
                </div>
              ...
              <svg className="w-4 h-4 text-[#C8C4BC] group-hover:text-[#8A8682] transition-colors shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
